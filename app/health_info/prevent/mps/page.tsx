...
const mt_title = 'Health Hub | 【予防】筋筋膜性疼痛症候群'
const mt_description = 'HealthHub | 筋筋膜性疼痛症候群についてや予防に関する情報や運動方法について提供するページです。'
export const metadata: Metadata = {
  title: mt_title,
  description: mt_description,
  keywords: ['健康', 'ヘルスケア', '運動', '栄養', 'AI', '情報', '予防', '筋筋膜性疼痛症候群'],
  openGraph: {
    type: 'website',
    locale: 'ja_JP',
  ...
  return (
    <>
      ...
      <JsonLd crumbs={[
        ...
        { name: "MPS", href: "/health_info/prevent/mps" },
      ]} />
    </>
  );
}