...
const mt_title = 'Health Hub | 【コンデション】睡眠'
const mt_description = 'HealthHub | 睡眠にまつわる知見やコンディショニングについて提供するページです。'
export const metadata: Metadata = {
  title: mt_title,
  description: mt_description,
  keywords: ['健康', 'ヘルスケア', '運動', '栄養', 'AI', '情報', '予防', '睡眠'],
  openGraph: {
    type: 'website',
    locale: 'ja_JP',
  ...
  return (
    <>
      ...
      <JsonLd crumbs={[
        ...
        { name: "Sleep", href: "/health_info/prevent/sleep" },
      ]} />
    </>
  );
}