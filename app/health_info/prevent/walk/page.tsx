...
const mt_title = 'Health Hub | 【コンデション】歩く'
const mt_description = 'HealthHub | 歩くにまつわる知見やコンディショニングについて提供するページです。'
export const metadata: Metadata = {
  title: mt_title,
  description: mt_description,
  keywords: ['健康', 'ヘルスケア', '運動', '栄養', 'AI', '情報', '予防', '歩く'],
  openGraph: {
    type: 'website',
    locale: 'ja_JP',
  ...
  return (
    <>
      ...
      <JsonLd crumbs={[
        ...
        { name: "Walk", href: "/health_info/prevent/walk" },
      ]} />
    </>
  );
}